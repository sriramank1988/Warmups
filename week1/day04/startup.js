...
randomThisIdeaIndex = thisArray[Math.floor(Math.random() * thisArray.length-1)];
randomThatIdeaIndex = thatArray[Math.floor(Math.random() * thatArray.length-1)];
console.log('I want build ' + randomThisIdeaIndex + ' with ' + randomThatIdeaIndex);